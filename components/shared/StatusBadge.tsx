...
const STATUS_CONFIG: Record<string, { label: string; cls: string }> = {
  ...
  completed:     { label: 'Completed',     cls: 'bg-blue-500/10 text-blue-500 border-blue-500/30' },
  paid:          { label: 'Paid',          cls: 'bg-blue-500/10 text-blue-500 border-blue-500/30' },
  ...
  kyc_submitted: { label: 'KYC Submitted', cls: 'bg-blue-500/10 text-blue-400 border-blue-500/30' },
