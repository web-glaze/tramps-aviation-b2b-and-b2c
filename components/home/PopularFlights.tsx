  ...
  return (
    <button onClick={onClick}
      ...
      <div className="flex items-center gap-2 mb-3.5">
        <div className={cn("w-7 h-7 rounded-lg flex items-center justify-center text-white text-xs font-black flex-shrink-0 shadow-sm", acColor(route.airline))}>
          {(route.airline||"?")[0]}
        </div>
        <span className="text-[11px] text-muted-foreground font-medium truncate">{route.airline||"Any"}</span>
      </div>
      ...
      <div className="flex items-center gap-1.5 mb-3.5">
        <div className="text-center flex-shrink-0">
          ...
          <p className="text-[10px] text-muted-foreground mt-0.5">{route.fromCity}</p>
        </div>
        <div className="flex-1 flex flex-col items-center gap-0.5">
          ...
          <span className="text-[9px] text-muted-foreground/80 whitespace-nowrap">{route.duration||""}</span>
        </div>
        <div className="text-center flex-shrink-0">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between mb-5 sm:mb-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-muted-foreground mt-1 ml-10">Top routes · click to search</p>
          </div>
