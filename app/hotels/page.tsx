              ...
              {role !== "agent" && (
                <div className="space-y-1.5 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">₹{ppn.toLocaleString("en-IN")} × {nights} night{nights>1?"s":""}</span>
                  ...
                  <div className="flex justify-between font-bold border-t border-border pt-1.5 mt-1.5">
                    <span>Total</span>
                    <span style={{color:"hsl(var(--brand-orange))"}}>₹{total.toLocaleString("en-IN")}</span>
                  </div>
                </div>
              )}
            </div>
