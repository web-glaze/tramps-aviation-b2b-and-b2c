...
export default function BookingConfirmPage() {
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      const loginPath = isAgent
        ? `/b2b/login?redirect=/booking/${bookingId}`
        : `/b2c/login?redirect=/booking/${bookingId}`;
    ...
    <div className="pt-8 pb-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-6 justify-center">
          ...
          <Link href={isAgent ? "/b2b/bookings" : "/b2c/my-trips"}>
        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden print:border-black">
          ...
          <div className="bg-gradient-to-r from-blue-700 to-indigo-700 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              {booking.type === "Flight" ? <Plane className="h-5 w-5 text-primary-foreground" />
                : booking.type === "Hotel" ? <Hotel className="h-5 w-5 text-white" />
                : <Shield className="h-5 w-5 text-primary-foreground" />}
              <span className="font-bold text-foreground">{booking.type} Booking</span>
            </div>
          ...
          {booking.type === "Flight" && (
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  <p className="text-4xl font-black text-foreground">{booking.from}</p>
                ...
                <div className="text-right">
                  <p className="text-4xl font-black text-foreground">{booking.to}</p>
          ...
          {booking.type === "Hotel" && (
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-foreground">{booking.hotelName}</h2>
          ...
          {booking.type === "Insurance" && (
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-foreground">{booking.planName}</h2>
          ...
          <div className="mx-6 mb-6 bg-green-900/20 border border-green-800/40 rounded-xl p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-2xl font-black text-foreground">₹{booking.totalAmount.toLocaleString()}</p>
        ...
        <div className="mt-6 flex justify-between items-center">
          ...
          <Link href={isAgent ? "/b2b/bookings" : "/b2c/my-trips"}>
            <Button variant="outline" size="sm" className="border-border text-foreground/80 hover:text-foreground">
              View All Bookings
            </Button>
          </Link>
        </div>
