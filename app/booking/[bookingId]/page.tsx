      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-green-900/40 to-emerald-900/40 border border-green-500/30 rounded-2xl p-6 mb-6 text-center">
          ...
          <p className="text-foreground/80 text-sm">
            Your {booking.type.toLowerCase()} has been booked successfully.
        ...
        <div className="flex flex-wrap gap-2 mb-6 justify-center">
          ...
          {booking.pnr && (
            <Button
              ...
              className="gap-2 border-border text-foreground/80"
            >
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-center flex-1 px-4">
                  <p className="text-xs text-muted-foreground mb-1">
                    {booking.duration} · {booking.stops}
                  </p>
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 max-w-32 text-right">
                    {booking.toCity}
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  { icon: User, label: "Class", value: booking.class },
                  {
                    icon: Shield,
                    label: "Refund",
                    value: booking.refundable ? "Refundable" : "Non-refundable",
                  },
                ].map((item) => (
                  <div key={item.label} className="bg-muted/50 rounded-xl p-3">
                    ...
                    <p
                      className={`text-sm font-bold text-foreground mt-0.5 ${item.mono ? "font-mono" : ""}`}
                    >
                      {item.value}
                    </p>
                  </div>
              ...
              <div className="mt-5 pt-5 border-t border-border">
                ...
                {booking.passengers.map((p: any, i: number) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 bg-muted/40 rounded-xl p-3 mb-2"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={item.label} className="bg-muted/50 rounded-xl p-3">
                    ...
                    <p
                      className={`text-sm font-bold text-foreground mt-0.5 ${(item as any).mono ? "font-mono" : ""}`}
                    >
                      {item.value}
                    </p>
                  </div>
